...
My research focuses on how bacteria develop resistance to antibiotics. My work involves studying the genes behind this resistance and how they can move between bacteria, using computational tools to better understand these processes. You can find more information about my projects under [Projects]({% link _pages/projects.md %}) and some example of the workflows under [Repositories]({% link _pages/repositories.md %}).  
